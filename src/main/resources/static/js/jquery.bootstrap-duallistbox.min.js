...
!function (n) {
    ...
    function h(e) {
        if (e.settings.infoText) {
            var t = e.elements.select1.find("option").length, n = e.elements.select2.find("option").length,
                s = e.element.find("option").length - e.selectedElements, i = e.selectedElements, l = "";
    ...
    function e(i, l) {
        if (i.settings.showFilterInputs) {
            ...
            var o, r = i.element.find("option"), e = i.element;
    ...
    function u(e) {
        ...
        t.sort(function (e, t) {
            var n = parseInt(e.getAttribute("data-sortindex")), s = parseInt(t.getAttribute("data-sortindex"));
    ...
    l.prototype = {
        ...
        }, setMoveOnDoubleClick: function (e, t) {
